CLASS zcl_05_data_objects DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_05_DATA_OBJECTS IMPLEMENTATION.
...
* Kommentieren/entkommentieren Sie die folgenden Zeilen, um den Typ von my_var zu ändern
...
* Variable basierend auf dem lokalen Typ
