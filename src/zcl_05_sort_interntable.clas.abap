CLASS zcl_05_sort_interntable DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_05_SORT_INTERNTABLE IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    flights = VALUE #( ( client = sy-mandt carrier_id = 'LH' connection_id = '0500' flight_date = '20230201' plane_type_id = '747-400' price = '600' currency_code = 'EUR' )
    ...
    ( client = sy-mandt carrier_id = 'LH' connection_id = '0900' flight_date = '20230201' plane_type_id = '777-200' price = '600' currency_code = 'USD' ) ).
