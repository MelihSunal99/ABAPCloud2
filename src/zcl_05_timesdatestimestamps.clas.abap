CLASS zcl_05_timesdatestimestamps DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_05_TIMESDATESTIMESTAMPS IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    timestamp2 = utclong_add( val = timestamp1 days = 7 hours = 1 ).
    out->write( |Added 7 days and 1 hours to current UTC time { timestamp2 }| ).
