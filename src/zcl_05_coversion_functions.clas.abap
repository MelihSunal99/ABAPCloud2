CLASS zcl_05_coversion_functions DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_05_COVERSION_FUNCTIONS IMPLEMENTATION.
...
*// Dieser Code geht nicht aber hier die Ausgabe:
* total price: 2917.0, currency_code: USD total_price_eur: 2990.57
