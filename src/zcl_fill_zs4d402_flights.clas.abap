CLASS zcl_fill_zs4d402_flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_FILL_ZS4D402_FLIGHTS IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT ZS4D402_flights FROM TABLE @insert_tab.
